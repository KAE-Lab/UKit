...
- **Lire la page d'engagement ne fait plus recommencer le formulaire** (6.1.x-C). Le formulaire de
  ...
  Depuis le formulaire, un lien qui sort de chez Google s'ouvre par-dessus, dans une seconde page du
  navigateur intégré, et « retour » retrouve le formulaire là où il en était ; les portails
  universitaires ne changent pas.
