...
export const ANNONCES: Descripteur = {
    ...
    champs: [
        ...
        { nom: 'image_url', libelle: 'Visuel', type: { type: 'image', dossier: 'annonces' }, aide: 'Une affiche carrée (1:1), jamais recadrée. Vide : la carte compose une affiche typographique.' },
