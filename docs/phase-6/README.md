...
```
   ...
   6.1 — LA CONSOLIDATION (decidee le 2026-09-02, docs 6-1-*)
                    ...
                    6.1-A robustesse scolarite   [livre]
                              |
                    6.1-B pilotage a distance [livre]      6.1-D publication (parallele)
                              |
                    6.1-C passe de code [livre]
                              |
                    6.1-E finitions d'interface [livre]
                              |
                    6.1-Z sortie
   ...
   6.1.x — LE SOCLE ET LES DEMANDES (decidee le 2026-09-06, numero a la fin)
                    ...
                    C les retours entrent en base, lus dans la console (sans build)   [livre]
                    D les calendriers du telephone dans le Planning
                      + le ciblage par plateforme   [livre]
                    E les messages de service en notification PUSH   [livre, fonction deployee]
                    Z sortie — la verification Android de TOUS les jalons, en une fois

   6.2.x — LES AJUSTEMENTS D'APRES SORTIE (decides le 2026-09-11, un seul jalon en lots)

                    0 docs : ce que la production a confirme, le second appareil permanent
                    1 filtres d'UE dans la synchronisation
                    2 lieu d'un rendez-vous du telephone, "S'y rendre"
                    3 "Reserver" de la BU en primaire, dans la vue integree
