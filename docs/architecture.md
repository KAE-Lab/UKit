...
| [`shared/annonces/grammaire.ts`](../src/shared/annonces/grammaire.ts) · [`grammaire.test.ts`](../src/shared/annonces/grammaire.test.ts) | la grammaire de la description d'une annonce — blocs, titres iconés, puces, exergue, transition, signature, gras, marque de fin — rendue en arbre ; pur, partagé avec la console qui dessine le même arbre en HTML (7-F) ([campus-vie-etudiante.md](features/campus-vie-etudiante.md)) |
