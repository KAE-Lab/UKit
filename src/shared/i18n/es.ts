...
const es: TranslationDict = {
	...
	NOTIFICATION_DELAY: "Retraso antes del curso",
	NOTIFICATION_DELAY_DESC: "Ajusta cuántos minutos antes del inicio del curso deseas ser notificado.",
	SCHEDULE_SOURCE: "Fuente del horario",
	ICAL_LINK: "Enlace iCal",
	ICAL_LINK_TITLE: "Enlace iCalendar (iCal)",
	HOW_TO_FIND_LINK: "¿Cómo encontrar mi enlace?",
	VALIDATE_LINK: "Validar enlace",
	ERROR: "Error",
	ENTER_VALID_URL: "Por favor, introduce una URL válida.",
	INVALID_ICAL_URL: "El enlace proporcionado no ha devuelto eventos válidos.",
	ICAL_FETCH_ERROR: "No se ha podido obtener el horario desde este enlace.",
	TUTORIAL_SATELLYS_TITLE: "Intranet Satellys",
	TUTORIAL_SATELLYS_STEP_1: "Inicia sesión en tu espacio Satellys desde el navegador de tu teléfono.",
	TUTORIAL_SATELLYS_STEP_2: "Ve a tu horario.",
	TUTORIAL_SATELLYS_STEP_3: "Busca el botón de exportación",
	TUTORIAL_SATELLYS_STEP_4: "Haz una",
	TUTORIAL_SATELLYS_STEP_4_BOLD: "pulsación larga",
	TUTORIAL_SATELLYS_STEP_4_END: "en este botón.",
	TUTORIAL_SATELLYS_STEP_5: "Selecciona",
	TUTORIAL_SATELLYS_STEP_5_BOLD: "\"Copiar dirección del enlace\"",
