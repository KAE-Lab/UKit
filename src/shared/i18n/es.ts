...
const es: TranslationDict = {
	...
	ERROR_UNEXPECTED_RESPONSE: 'La fuente ha respondido algo que no esperábamos. Estamos en ello.',
	ERROR_CONTENT_NOT_FOUND_TITLE: 'Contenido no encontrado',
	ERROR_CONTENT_NOT_FOUND: 'La fuente ha cambiado de forma. Estamos en ello.',
	ERROR_BLOCKED_TITLE: 'Solicitud interrumpida',
	ERROR_BLOCKED: 'No se ha podido completar la solicitud.',
	ERROR_MISSING_CREDENTIALS_TITLE: 'Falta información',
	ERROR_MISSING_CREDENTIALS: 'Esta solicitud necesita algo que aún no tenemos.',
	ERROR_INTERNAL_TITLE: 'Problema por nuestra parte',
	ERROR_INTERNAL: 'No eres tú. Estamos en ello.',
	...
	ERROR_PORTAL_UNAVAILABLE_TITLE: 'Universidad no conectada',
	...
	ERROR_SERVICE_ABSENT: 'Tu centro no ofrece este servicio en UKit.',
	...
	REFRESH_RECORD: "Actualizar mi expediente",
	REFRESH_RECORD_DESC: 'Se repetirá por completo tu inicio de sesión universitario para actualizar tu expediente. Tarda unos segundos.',
	...
	PROPOSALS_INTRO: "Tu conexión universitaria nos ha dicho algo más. No se aplicará nada sin tu consentimiento.",
	PROPOSALS_EDT_LABEL: "Tu horario",
	PROPOSALS_EDT_HINT: "Se añadirá a tus favoritos, como un grupo. Puedes quitarlo cuando quieras.",
	PROPOSALS_UES_LABEL: "Las asignaturas que no cursas",
	...
	MY_SERVICES: "Tus servicios",
	MY_DOCUMENTS: "Tus documentos",
	RECORD_NEVER_READ: "Expediente nunca actualizado",
	PROGRAMME: "Formación",
	SERVICE_ENT_SUBTITLE: "Portal de la universidad",
	...
	NO_DOCUMENTS: "Guarda aquí tus certificados de matrícula y tus justificantes: se quedan en tu dispositivo y funcionan sin conexión.",
	...
	CAMPUS_NOT_SUPPORTED_TITLE: "Campus no compatible",
	CAMPUS_NOT_SUPPORTED: "UKit todavía no conecta los servicios de tu centro. Dinos cuál es: la demanda decide el orden en que los añadimos.",
	CAMPUS_REQUEST_ACTION: "Solicitar mi centro",
	RECORD_READ_LABEL: "Última lectura",
