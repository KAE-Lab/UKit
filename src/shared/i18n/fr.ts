...
const fr: TranslationDict = {
	...
	NO_RESULTS_FOUND: 'Aucun résultat pour cette recherche.',
	...
	REFRESH_RECORD_DESC: "Rejoue la connexion complète pour remettre à jour ton identité.",
	CONNECT: "Se connecter",
	CONNECTING: "Connexion en cours...",
	LOGIN_FAILED: "Identifiants incorrects. Vérifiez votre nom d'utilisateur et votre mot de passe.",
	LOGIN_NETWORK_ERROR: "Impossible de joindre le portail. Vérifiez votre connexion.",
	...
	ENTER_CREDENTIALS_DESC: "Entrez vos identifiants ENT pour vous connecter automatiquement.",
	CREDENTIALS_SAVED_SUCCESS: "Identifiants sauvegardés avec succès !",
	CREDENTIALS_DELETED_SUCCESS: "Identifiants supprimés.",
	SAVE_CREDENTIALS_PROMPT: "Voulez-vous sauvegarder vos identifiants pour vous connecter automatiquement la prochaine fois ?",
	CONFIRM_SAVE_CREDENTIALS: "Êtes-vous sûr de vouloir sauvegarder ces identifiants ?",
	...
	BIOMETRY_PROMPT: "Authentifiez-vous pour accéder à vos informations",
